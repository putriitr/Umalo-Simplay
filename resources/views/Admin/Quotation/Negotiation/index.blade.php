            ...
            @foreach($negotiations as $negotiation)
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-success btn-sm" onclick="openModal({{ $negotiation->id }}, 'accept')">Accept</button>
                        <!-- Tombol untuk memicu modal Reject -->
                        <button class="btn btn-danger btn-sm" onclick="openModal({{ $negotiation->id }}, 'reject')">Reject</button>
                    </td>
                </tr>
            @endforeach
        </tbody>
