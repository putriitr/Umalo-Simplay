...
<div class="container">
    <div class="card shadow-lg border-0">
        <div class="card-header">
            <h2>Edit Quotation for: {{ $quotations->first()->user->name ?? 'N/A' }}</h2>
        </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.quotations.update', $quotation->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-sm" id="recipient_company"
                                name="recipient_company"
                                value="{{ old('recipient_company', $quotation->user->nama_perusahaan ?? 'N/A') }}"
                                readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-sm" id="client_contact"
                                name="recipient_contact_person"
                        ...
                        <tbody>
                            @foreach($quotation->quotationProducts as $key => $product)
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" class="form-control shadow-sm unit-price"
                                            name="products[{{ $key }}][unit_price]"
                                            value="{{ old("products.$key.unit_price", $product->unit_price ?? 0) }}"
                                            data-qty="{{ $product->quantity }}">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control shadow-sm total-price"
                ...
                <div class="row mt-4">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control shadow-sm" id="subtotal_price"
                                name="subtotal_price" value="{{ old('subtotal_price', $quotation->subtotal_price) }}"
                                readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control shadow-sm" id="total_after_discount"
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control shadow-sm" id="notes" name="notes"
                        rows="4">{{ old('notes', $quotation->notes) }}</textarea>
                </div>

                <div class="mb-3">
                    <label for="terms_conditions" class="form-label">Terms and Conditions</label>
                    <textarea class="form-control shadow-sm" id="terms_conditions" name="terms_conditions"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control shadow-sm" id="signer_position"
