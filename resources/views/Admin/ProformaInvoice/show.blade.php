                            ...
                            @foreach ($proformaInvoice->payment_proof_paths as $index => $filePath)
                                <div class="mt-2">
                                    ...
                                    @if ($proformaInvoice->last_payment_status === 'pending' && $index + 1 === $proformaInvoice->payments_completed + 1)
                                        <form action="{{ route('admin.proforma-invoices.approve-reject', $proformaInvoice->id) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="remarks" id="remarks_{{ $index }}" rows="2" class="form-control"
                                                    required></textarea>
                                            </div>
                                            ...
                                            @if ($index + 1 < $proformaInvoice->installments)
                                                <!-- Input Persentase Pembayaran -->
                                                <div class="mb-3">
                                                    <label for="next_payment_percentage_{{ $index }}" class="form-label">Next Payment
                                                        Percentage</label>
